...
if __name__ == "__main__":
    ...
    dataset_path = r"C:\Users\ASUS\OneDrive\Documents\kuliah\ComputerVision_OCR\Indonesian License Plate Recognition Dataset\test"  # Sesuaikan dengan lokasi dataset Anda
